...
class RadianceParameters(object):
    ...
    @property
    def ar(self):
        """Return ambient resolution. "This number will determine the maximum density of ambient values used in interpolation. Error will start to increase on surfaces spaced closer than the scene size divided by the ambient resolution. The maximum ambient value density is the scene size times the ambient accuracy."""
        return self.getParameterValue("ar")

    @ar.setter
    def ar(self, value):
        """Set ambient resolution. "This number will determine the maximum density of ambient values used in interpolation. Error will start to increase on surfaces spaced closer than the scene size divided by the ambient resolution. The maximum ambient value density is the scene size times the ambient accuracy."""
    ...
    def __parseRadParameters(self, parametersString):
        """Parse radiance parameters and returns a dictionary of parameters and values
        """
