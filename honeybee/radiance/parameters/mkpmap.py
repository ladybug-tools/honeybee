...
class MkpmapParameters(AdvancedRadianceParameters):
    ...
    def __init__(self):
        ...
        self.add_radiance_value("apg",descriptive_name='global photon output file',attribute_name='global_photon_file')
        self.global_photon_file=None

        self.add_radiance_value("apc",descriptive_name='caustic photon output file',attribute_name='caustic_photon_file')
        ...
        self.add_radiance_value("apC", descriptive_name='contribution photon output file',
        ...
        self.add_radiance_number('apP', descriptive_name="precomputed global photons fraction",
                                 attribute_name="precomp_global_photon_frac",valid_range=(0,1))
        self.precomp_global_photon_frac=None

        self.add_radiance_number('apm',descriptive_name='max number of bounces',attribute_name='max_bounce')
        self.max_bounce=None

        self.add_radiance_number('apM', descriptive_name='max number of iterations of distribution prepass',
                                 attribute_name='max_prepass')
        self.max_prepass = None


        self.add_radiance_value('apo',descriptive_name='photon port modifier name',attribute_name='photon_port_modifier')
        ...
        self.add_radiance_number('n',descriptive_name='number of processors',attribute_name='number_processers')
